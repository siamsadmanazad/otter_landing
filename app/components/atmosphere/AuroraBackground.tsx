...
export function AuroraBackground() {
  return (
    <div aria-hidden className="pointer-events-none fixed inset-0 z-0 overflow-hidden bg-noir-950">
      ...
      <div
        className="absolute -left-[18%] -top-[22%] h-[72vmax] w-[72vmax] rounded-full opacity-30 blur-[var(--fx-blur-aurora)]"
        style={{
      ...
      {/* Violet bloom (depth) */}
      <div
        className="absolute -right-[14%] top-[18%] h-[64vmax] w-[64vmax] rounded-full opacity-25 blur-[var(--fx-blur-aurora)]"
        style={{
      ...
      <div
        className="absolute bottom-[-20%] left-[20%] h-[60vmax] w-[60vmax] rounded-full opacity-30 blur-[var(--fx-blur-aurora)]"
        style={{
      ...
      <div
        className="absolute bottom-[-30%] right-[10%] h-[40vmax] w-[40vmax] rounded-full opacity-[0.12] blur-[var(--fx-blur-aurora)]"
        style={{
